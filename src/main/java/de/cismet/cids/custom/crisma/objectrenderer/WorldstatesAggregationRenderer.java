...
public class WorldstatesAggregationRenderer extends AbstractCidsBeanAggregationRenderer
    ...
    private final HashMap<Integer, DefaultCategoryDataset> charts = new HashMap<Integer, DefaultCategoryDataset>(6);
    ...
    private void updateOWATable() {
        ...
        tblRankings.getColumn("Criteria Overview").setCellRenderer(new DefaultTableCellRenderer() {
                ...
                public Component getTableCellRendererComponent(final JTable table,
                    ...
                    p.setToolTipText(String.valueOf(row));
                    charts.put(row, dataset);
...
//        }
    ...
    public void dispose() {
        ...
        try {
            ...
            final String s = m.writeValueAsString(singleColumnModelCritFunc.funcs);
    ...
    private final class SingleColumnModelCritFunc implements TableModel {
        ...
        public void setEditingRow(final Integer rowIndex) {
            if ((editingRow != null) && (rowIndex == null)) {
                for (final CritFuncBand cfb : funcs.get(editingRow).bands) {
                    final IndicatorBand band = valueBands.get(cfb.name);
                    cfb.setGroups(new TreeSet(band.getGroups()));
                }
            }
